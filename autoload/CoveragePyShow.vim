...
endpython
    ...
    call keyMap#Create(
\       {'scope':'coveragepy',
\        'text': 'press o to open failing test',
\        'key': 'o',
\        'callback': function  ('CoveragePyShow#GotoTest')})

    call keyMap#Create(
\       {'scope':'coveragepy',
\        'text': 'press e to display exception',
\        'key': 'e',
\        'callback': function  ('CoveragePyShow#ShowException')})

    call keyMap#Create(
\       {'scope':'coveragepy_exception',
\        'text': 'press u to go back to test results',
\        'key': 'u',
\        'callback': function  ('CoveragePyShow#LoadSavedPanel')})
